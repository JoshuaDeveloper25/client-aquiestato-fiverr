...
const FormEditProduct = ({ infoRow, slug, setSlug, isPending }) => {
  return (
    <>
      <div className="grid gap-4 mb-4 grid-cols-2">
        <div className="col-span-2">
          <InputForm
            ...
            valueEvent={slug}
            defaultValue={infoRow?.productName}
          />
        </div>
        ...
        <div className="col-span-2">
          <label className="block">
            ...
            <textarea
              name="description"
              className="bootstrap-input w-full h-20 block"
              defaultValue={infoRow?.description}
            ></textarea>
          </label>
        </div>
      </div>
